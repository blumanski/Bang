...
class Awss3
{
     ...
     * @param string $filePath  		- $_FILES['file']['tmp_name']
     * @param string $filename  		- $_FILES['file']['name']
     * @param string $destinationPath 	- subfolder to save the file 
     * @param string $cachetime  		- cache time in strtotime format
     */
    ...
    /**
     * Upload an object to aws s3 server
     * @param string Body  				- Text or otehr content
     * @param string $filename  		- $_FILES['file']['name']
     * @param string $destinationPath 	- subfolder to save the file
     * @param string $cachetime  		- cache time in strtotime format
     */
     ...
     * @param string $name - filename including sub directories
     */
